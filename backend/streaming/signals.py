...
def video_post_save(sender, instance, created, **kwargs):
    if created and instance.video_file:
        ...
        # Enqueue HLS conversion and teaser generation
        ...
        instance.teaser_file = os.path.join('teasers', f'{instance.id}_teaser.mp4')  # Set teaser file path directly
        instance.save(update_fields=['hls_playlist', 'teaser_file'])

        # Set video status to Done after all jobs complete
...
def video_post_delete(sender, instance, **kwargs):
    ...
    if instance.teaser_file:
        teaser_file = instance.teaser_file.path  # Korrektur: .path hinzufügen, um den tatsächlichen Pfad zu erhalten
